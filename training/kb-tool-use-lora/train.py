#!/usr/bin/env python3
"""
Fresh 2-query CDS + SCRIBE SFT training from base MedGemma.
Self-contained -- only needs: config.yaml, train_2query.jsonl, val_2query.jsonl, data_loader.py
"""
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("2-Query CDS + SCRIBE SFT Training")
    ...
    training_args = SFTConfig(
        ...
        eval_steps=train_cfg.get("eval_steps", 100) if val_ds else None,
